            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      IconButton(onPressed: () => share(), icon: Icon(Icons.share_outlined, color: Colors.grey)),
                      SizedBox(width: 20.0),
                      IconButton(onPressed: (){
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          ...
                          color: Colors.grey)),
                      SizedBox(width: 15.0),
                      IconButton(onPressed: ()=> bookmark?_deleteItem(widget.item.id):_addItem(), icon: Icon(
                         bookmark?CupertinoIcons.bookmark_fill: CupertinoIcons.bookmark, color: Colors.grey)
                      )
                      ,
                    ],
                  ),
